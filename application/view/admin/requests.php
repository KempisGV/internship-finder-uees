									...
									<article class="noo_job hentry">
										<div class="loop-item-wrap">
											<div class="loop-item-content">
												<h2 class="loop-item-title" style="color: #811435;"><?= $request->institution_name; ?></h2>
											...
											<div class="show-view-more">
												<a class="btn btn-primary mb-1 white" href="<?= Config::get('URL') . 'admin/approveuser/' . $request->request_id; ?>">Crear Usuario</a><br>
												<a class="btn btn-default white" href="<?= Config::get('URL') . 'admin/updaterequest/' . $request->request_id; ?>">Editar Solicitud</a>
											</div>
										</div>
									</article>
									<?php } ?>
